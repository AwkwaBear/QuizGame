...
void topic::generate_topic_hawaii(){//begin function
    std::srand(std::time(0));
    //create string to store current line
    std::string line;
    ...
    //create ifstream for applicable file
    std::ifstream myfile ("hawaii.txt");
...
void topic::generate_topic_pop(){//begin function
    std::srand(std::time(0));
    //create string to store current line
    std::string line;
    ...
    //create ifstream for applicable file
    std::ifstream myfile ("popculture.txt");
...
void topic::generate_topic_history(){//begin function
    std::srand(std::time(0));
    //create string to store current line
    std::string line;
    ...
    //create ifstream for applicable file
    std::ifstream myfile ("ushistory.txt");
